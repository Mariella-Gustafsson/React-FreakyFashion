...
const Hero = () => {
  ...
  return (
    <section className="relative sm:h-[300px] lg:h-[380px]">
      <img
        src="images/Hero.jpg"
      ...
      />
        ...
        <p className="absolute bottom-3 w-[70%] text-center left-1/2 transform -translate-x-1/2 text-shadow text-[#f8f8f8] font-bold font-[Rowdies] sm:right-3 sm:text-2xl lg:text-3xl lg:bottom-6">
